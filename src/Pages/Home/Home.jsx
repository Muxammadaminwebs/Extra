      ...
      <div className="row">
        <div className="col-8 WrapperLeftPage">
          ...
          <div className="Pay">
            ...
            {/* <!-- Tabs navs --> */}
            <ul className="nav nav-tabs mb-3 Pay-ul" id="ex1" role="tablist">
              <li className="nav-item" role="presentation">
                <a
                  className="nav-link active TabPay d-flex"
                  id="ex3-tab-1"
                  data-mdb-toggle="tab"
                  href="#ex3-tabs-1"
                  role="tab"
                ...
                >
                  ...
                  <i className="bi bi-brightness-low-fill ptichka"></i>
              ...
              >
                <form action="" className="Tab1Form">
                  ...
                  <Input
                    type="text"
                    id="Tab1Input1"
                    inputclassName="Tab1InputclassName"
                    val={cardName}
